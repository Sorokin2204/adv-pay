...
const GamePage = () => {
  ...
  const gameList = [
    ...
    },
    {
      ...
      privacyContent: (
        <>
          Игровую валюту на данной странице вы донатите в пользу NetEase Games. Мы не являемся правообладателем игровой валюты Onmyoji Arena, не определяем порядок её использования и функционирования в игре. Производя донат в игру Onmyoji Arena вы соглашаетесь с данным <a class="link" href="https://www.onmyojiarena.us/law.html">пользовательским соглашением</a>, <a class="link" href=" https://donate-gold.ru/terms-of-use">пользовательским соглашением Donate Gold</a> и нашей <a class="link" href="https://donate-gold.ru/privacy-policy">политикой конфиденциальности</a>.
        </>
      ),
    },
  ];
